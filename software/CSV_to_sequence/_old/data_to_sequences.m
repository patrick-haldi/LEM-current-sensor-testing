function data_to_sequences(data)
    ...
    string_step_value_to_end            = string_from_file([current_folder '/components/step_value_to_end.xml']);
    ...
    for sequence_file_nr = 1:total_file_nr;
        ...
        for current_step_in_file = 1:(number_of_steps_in_file)
            ...
            string_sequence = add_to_string(string_sequence, num2str((current_step_in_file + 2) * 100));
            ...
            string_sequence = add_to_string(string_sequence, string_step_value_to_end);
        end
